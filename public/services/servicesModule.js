    ...
    .factory('dataManagement', function ($http) {
        return {
            getCarriers: function () {
                var carrierPromise = $http({
                    method: 'GET',
                    url: 'http://localhost:3000/flights/carriers'
                });
            ...
            getFlightDetails: function (carrierName, flightName) {
                var detailspromise = $http({
                    method: 'GET',
                    url: 'http://localhost:3000/flights/carriers/' + carrierName + '/' + flightName
                });
                return detailspromise;
            }
        }
